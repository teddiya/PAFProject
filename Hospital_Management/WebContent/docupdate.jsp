...
<%
	...
	if (request.getParameter("DocLNo") != null) { //`DocID`,`DocLNo`,`Name`,`NIC`,`PhoneNo`,`Email`,`Address`,`DocSpeacialist`,`WorkingXp`,`Password`
		...
		String stsMsg = itemObj.insertItem(request.getParameter("DocLNo"), request.getParameter("Name"),
				...
				request.getParameter("Address"), request.getParameter("DocSpeacialist"),
				request.getParameter("WorkingXp"), request.getParameter("Password"));
				...
				<div class="card-body">
					<form method="POST" action="docupdate.jsp">
						<div class="form-row m-b-55">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="DocLNo">
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="NIC">
								</div>
							</div>
						</div>
						<div class="form-row m-b-55">
						...
						<div class="form-row">
							<div class="name">Speacilist for</div>
							<div class="value">

								<select id="cars" name="DocSpeacialist">
									<option value="Allergists/Immunologists">Allergists/Immunologists</option>
									<option value="Anesthesiologists">Anesthesiologists</option>
									<option value="Colon and Rectal Surgeons">Colon and
										Rectal Surgeons</option>
									<option value="Critical Care Medicine Specialists">Critical
										Care Medicine Specialists</option>
									<option value="Dermatologists">Dermatologists</option>
									<option value="Endocrinologists">Endocrinologists</option>
									<option value="Emergency Medicine Specialists">Emergency
										Medicine Specialists</option>
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="WorkingXp">
								</div>
							</div>
						</div>
						...
						<div>
							...
							<a class="btn btn-primary" href="docDetails.jsp" role="button">Go
								To Doctor Details Page</a>
