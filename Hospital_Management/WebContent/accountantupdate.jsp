...
<%
	...
	if (request.getParameter("Acode") != null) { 
		...
		String stsMsg = itemObj.insertItem(request.getParameter("Acode"), request.getParameter("AName"),
		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				<div class="card-heading">
					<h2 class="title">Accountant Details Update Form</h2>
				</div>
				<div class="card-body">
					<form method="POST" action="accountantupdate.jsp">
						<div class="form-row m-b-55">
							<div class="name">Accountant code</div>
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="Acode">
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="AName">
								</div>
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="ANIC">
								</div>
							</div>
						</div>
						<div class="form-row m-b-55">
						...
						<div>
							...
							<a class="btn btn-primary" href="pharmacistdet.jsp" role="button">Go
								To Pharmacist Details Page</a>
